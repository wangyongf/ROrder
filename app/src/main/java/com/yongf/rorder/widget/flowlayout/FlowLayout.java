...
public class FlowLayout extends ViewGroup {
    ...
    private BaseFlowLayoutAdapter mAdapter;
     ...
     * @param adapter
     */
    public void setAdapter(@NonNull BaseFlowLayoutAdapter adapter) {
        if (adapter != null) {
            mAdapter = adapter;
            initView();
        }
    ...
    private class Line {
        // 属性
        private List<View> mViews = new ArrayList<>();    // 用来记录每一行有几个View
